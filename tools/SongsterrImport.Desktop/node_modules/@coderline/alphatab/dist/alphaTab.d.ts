 ...
 * @target web
 */
interface NotationSettingsJson {
    /**
     * Gets or sets the mode to use for display and play music notation elements.
     */
 ...
 * @target web
 */
interface ImporterSettingsJson {
    /**
     * The text encoding to use when decoding strings. By default UTF-8 is used.
     */
    encoding?: string;
 ...
 * @target web
 */
interface VibratoPlaybackSettingsJson {
    /**
     * Gets or sets the wavelength of the note-wide vibrato in midi ticks.
     */
    noteWideLength?: number;
 ...
 * @target web
 */
interface SlidePlaybackSettingsJson {
    /**
     * Gets or sets 1/4 tones (bend value) offset that
     * simple slides like slide-out-below or slide-in-above use.
     */
...
declare class TextGlyph extends EffectGlyph {
    ...
    constructor(x: number, y: number, text: string, font: Font, textAlign?: TextAlign, testBaseline?: TextBaseline | null);
    doLayout(): void;
    paint(cx: number, cy: number, canvas: ICanvas): void;
}
...
type index_d$6_BarreShape = BarreShape;
declare const index_d$6_BarreShape: typeof BarreShape;
type index_d$6_Beat = Beat;
declare const index_d$6_Beat: typeof Beat;
type index_d$6_BeatBeamingMode = BeatBeamingMode;
declare const index_d$6_BeatBeamingMode: typeof BeatBeamingMode;
...
type index_d$6_BracketExtendMode = BracketExtendMode;
declare const index_d$6_BracketExtendMode: typeof BracketExtendMode;
...
type index_d$6_FadeType = FadeType;
declare const index_d$6_FadeType: typeof FadeType;
...
type index_d$6_FontWeight = FontWeight;
declare const index_d$6_FontWeight: typeof FontWeight;
...
type index_d$6_NoteOrnament = NoteOrnament;
declare const index_d$6_NoteOrnament: typeof NoteOrnament;
...
type index_d$6_Rasgueado = Rasgueado;
declare const index_d$6_Rasgueado: typeof Rasgueado;
...
type index_d$6_SustainPedalMarker = SustainPedalMarker;
declare const index_d$6_SustainPedalMarker: typeof SustainPedalMarker;
type index_d$6_SustainPedalMarkerType = SustainPedalMarkerType;
declare const index_d$6_SustainPedalMarkerType: typeof SustainPedalMarkerType;
type index_d$6_Track = Track;
declare const index_d$6_Track: typeof Track;
type index_d$6_TrackNameMode = TrackNameMode;
declare const index_d$6_TrackNameMode: typeof TrackNameMode;
type index_d$6_TrackNameOrientation = TrackNameOrientation;
declare const index_d$6_TrackNameOrientation: typeof TrackNameOrientation;
type index_d$6_TrackNamePolicy = TrackNamePolicy;
declare const index_d$6_TrackNamePolicy: typeof TrackNamePolicy;
...
type index_d$6_WahPedal = WahPedal;
declare const index_d$6_WahPedal: typeof WahPedal;
type index_d$6_WhammyType = WhammyType;
declare const index_d$6_WhammyType: typeof WhammyType;
declare namespace index_d$6 {
  export { index_d$6_AccentuationType as AccentuationType, index_d$6_AccidentalType as AccidentalType, index_d$6_Automation as Automation, index_d$6_AutomationType as AutomationType, index_d$6_Bar as Bar, index_d$6_BarreShape as BarreShape, index_d$6_Beat as Beat, index_d$6_BeatBeamingMode as BeatBeamingMode, index_d$6_BendPoint as BendPoint, index_d$6_BendStyle as BendStyle, index_d$6_BendType as BendType, index_d$6_BracketExtendMode as BracketExtendMode, index_d$6_BrushType as BrushType, index_d$6_Chord as Chord, index_d$6_Clef as Clef, index_d$6_Color as Color, index_d$6_CrescendoType as CrescendoType, index_d$6_Duration as Duration, index_d$6_DynamicValue as DynamicValue, index_d$6_FadeType as FadeType, index_d$6_Fermata as Fermata, index_d$6_FermataType as FermataType, index_d$6_Fingers as Fingers, index_d$6_Font as Font, index_d$6_FontStyle as FontStyle, index_d$6_FontWeight as FontWeight, index_d$6_GraceType as GraceType, index_d$6_HarmonicType as HarmonicType, index_d$6_InstrumentArticulation as InstrumentArticulation, index_d$6_JsonConverter as JsonConverter, index_d$6_KeySignature as KeySignature, index_d$6_KeySignatureType as KeySignatureType, index_d$6_Lyrics as Lyrics, index_d$6_MasterBar as MasterBar, index_d$6_MusicFontSymbol as MusicFontSymbol, index_d$6_Note as Note, index_d$6_NoteAccidentalMode as NoteAccidentalMode, index_d$6_NoteOrnament as NoteOrnament, index_d$6_Ottavia as Ottavia, index_d$6_PickStroke as PickStroke, index_d$6_PlaybackInformation as PlaybackInformation, index_d$6_Rasgueado as Rasgueado, index_d$6_RenderStylesheet as RenderStylesheet, index_d$6_RepeatGroup as RepeatGroup, index_d$6_Score as Score, index_d$6_Section as Section, index_d$6_SimileMark as SimileMark, index_d$6_SlideInType as SlideInType, index_d$6_SlideOutType as SlideOutType, index_d$6_Staff as Staff, index_d$6_SustainPedalMarker as SustainPedalMarker, index_d$6_SustainPedalMarkerType as SustainPedalMarkerType, index_d$6_Track as Track, index_d$6_TrackNameMode as TrackNameMode, index_d$6_TrackNameOrientation as TrackNameOrientation, index_d$6_TrackNamePolicy as TrackNamePolicy, index_d$6_TripletFeel as TripletFeel, index_d$6_Tuning as Tuning, index_d$6_TupletGroup as TupletGroup, index_d$6_VibratoType as VibratoType, index_d$6_Voice as Voice, index_d$6_WahPedal as WahPedal, index_d$6_WhammyType as WhammyType };
}
 ...
 * @target web
 */
declare class AlphaTabApi extends AlphaTabApiBase<SettingsJson | Settings> {
...
declare class FontSizes {
    ...
    static measureString(s: string, families: string[], size: number, style: FontStyle, weight: FontWeight): TextMetrics;
}
...
type json_d_DisplaySettingsJson = DisplaySettingsJson;
type json_d_ImporterSettingsJson = ImporterSettingsJson;
type json_d_NotationSettingsJson = NotationSettingsJson;
type json_d_PlayerSettingsJson = PlayerSettingsJson;
type json_d_RenderingResourcesJson = RenderingResourcesJson;
type json_d_SettingsJson = SettingsJson;
type json_d_SlidePlaybackSettingsJson = SlidePlaybackSettingsJson;
type json_d_VibratoPlaybackSettingsJson = VibratoPlaybackSettingsJson;
declare namespace json_d {
  export type { json_d_CoreSettingsJson as CoreSettingsJson, json_d_DisplaySettingsJson as DisplaySettingsJson, json_d_ImporterSettingsJson as ImporterSettingsJson, json_d_NotationSettingsJson as NotationSettingsJson, json_d_PlayerSettingsJson as PlayerSettingsJson, json_d_RenderingResourcesJson as RenderingResourcesJson, json_d_SettingsJson as SettingsJson, json_d_SlidePlaybackSettingsJson as SlidePlaybackSettingsJson, json_d_VibratoPlaybackSettingsJson as VibratoPlaybackSettingsJson };
}

export { AlphaTabApi, AlphaTabError, AlphaTabErrorType, ConsoleLogger, CoreSettings, DisplaySettings, Environment, FileLoadError, FingeringMode, FormatError, type IEventEmitter, type IEventEmitterOfT, type ILogger, ImporterSettings, LayoutEngineFactory, LayoutMode, LogLevel, Logger, NotationElement, NotationMode, NotationSettings, PlayerOutputMode, PlayerSettings, ProgressEventArgs, RenderEngineFactory, RenderingResources, ResizeEventArgs, ScrollMode, Settings, StaveProfile, SystemsLayoutMode, TabRhythmMode, VibratoPlaybackSettings, WebPlatform, index_d$4 as exporter, index_d$5 as importer, json_d as json, VersionInfo as meta, index_d$3 as midi, index_d$6 as model, index_d$1 as platform, index_d$2 as rendering, index_d as synth };
